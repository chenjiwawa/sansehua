 ...
 */
public class UserRecyclerAdapterItem extends QsRecycleAdapterItem<App> {
    ...
    public UserRecyclerAdapterItem(LayoutInflater inflater, ViewGroup parent, boolean isItemPos) {
