package com.zl.dappore.invitelist.fragment;
...
import com.zl.dappore.invitelist.adapter.InviteRecyclerAdapterItem;
import com.zl.dappore.invitelist.model.InviteListConstants;
import com.zl.dappore.invitelist.presenter.InviteListPresenter;
...
public class InviteListFragment extends QsPullRecyclerFragment<InviteListPresenter, VoiceRoleList.VoiceRole> {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        type = arguments.getInt(InviteListConstants.BUNDLE_KEY_RECOMMENDLIST_REQUEST_TYPE, 0);
        app_taxon_id = arguments.getString(InviteListConstants.BUNDLE_KEY_RECOMMENDLIST_REQUEST_APP_TAXON_ID);
    ...
    public QsRecycleAdapterItem getRecycleAdapterItem(LayoutInflater mInflater, ViewGroup parent, int type) {
        return new InviteRecyclerAdapterItem(mInflater, parent);
    }
