...
//                requestLogout();
//
////                ChatRoomInputMessageDialogFragment dialogFragment = ChatRoomInputMessageDialogFragment.getInstance();
...
////                dialogFragment.setOnDialogListener(new ChatRoomInputMessageDialogFragment.OnDialogListener() {
////                    @Override
