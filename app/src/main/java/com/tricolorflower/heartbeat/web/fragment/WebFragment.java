package com.tricolorflower.heartbeat.web.fragment;
...
import com.tricolorflower.heartbeat.common.widget.progress.ColorProgressBar;
import com.tricolorflower.heartbeat.web.model.WebConstants;
import com.tricolorflower.heartbeat.web.presenter.WebPresenter;
...
public class WebFragment extends QsFragment<WebPresenter> implements DownloadListener {
    ...
    public void showWeb(String title, String urlOrData, int state) {
        this.mTitle = title;
