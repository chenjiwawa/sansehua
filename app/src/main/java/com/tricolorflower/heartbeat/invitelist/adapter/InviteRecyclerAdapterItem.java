...
public class InviteRecyclerAdapterItem extends VoiceRoleRecyclerAdapterItem {
    ...
    public InviteRecyclerAdapterItem(LayoutInflater inflater, ViewGroup parent, ItemListener itemListener) {
    ...
    protected void onBindItemData(VoiceRole data, int position, int totalCount) {
        ...
        btnActionVoiceRole.setOnClickListener(new View.OnClickListener() {
            @Override
