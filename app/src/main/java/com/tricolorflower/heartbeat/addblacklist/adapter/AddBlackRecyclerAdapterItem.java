package com.tricolorflower.heartbeat.addblacklist.adapter;
...
public class AddBlackRecyclerAdapterItem extends VoiceRoleRecyclerAdapterItem {
    ...
    public AddBlackRecyclerAdapterItem(LayoutInflater inflater, ViewGroup parent, ItemSingleSelectListener itemListener) {
