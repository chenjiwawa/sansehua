package com.tricolorflower.heartbeat.common.utils.zoom;
...
public class ZoomHelper {
    ...
    public Builder createBuilder(Activity activity) {
    ...
    public class Builder {
        ...
        public Builder hideStatusBar(boolean showStatusBar) {
        ...
        public Builder setZoomListener(ZoomListener listener) {
