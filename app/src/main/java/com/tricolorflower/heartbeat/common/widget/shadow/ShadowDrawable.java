package com.tricolorflower.heartbeat.common.widget.shadow;
...
public class ShadowDrawable extends Drawable {
    ...
    private ShadowDrawable(int shape, int[] bgColor, int shapeRadius, int shadowColor, int shadowRadius, int[] shadowPadding, int offsetX, int offsetY) {
        this.mShape = shape;
        this.mBgColor = bgColor;
        this.mShapeRadius = shapeRadius;
        this.mShadowRadius = shadowRadius;
        this.mShapePadding=shadowPadding;
    ...
    public void setBounds(int left, int top, int right, int bottom) {
        ...
        mRect = new RectF(left + mShapePadding[0] - mOffsetX, top + mShapePadding[1] - mOffsetY, right - mShapePadding[2] - mOffsetX,
                bottom - mShapePadding[3] - mOffsetY);
    }
    ...
    public static void setShadowDrawable(View view, int bgColor, int shapeRadius, int shadowColor, int shadowRadius,int[] shapePadding,int offsetX, int offsetY) {
        ShadowDrawable drawable = new ShadowDrawable.Builder()
                .setBgColor(bgColor)
                .setShapeRadius(shapeRadius)
                .setShadowColor(shadowColor)
                .setShadowRadius(shadowRadius)
                .setShadowPadding(shapePadding)
                .setOffsetX(offsetX)
                .setOffsetY(offsetY)
                .builder();
        view.setLayerType(View.LAYER_TYPE_SOFTWARE, null);
    ...
    public static class Builder {
        ...
        public Builder setShadowPadding(int[] shadowPadding) {
        ...
        public ShadowDrawable builder() {
            return new ShadowDrawable(mShape, mBgColor, mShapeRadius, mShadowColor, mShadowRadius,mShadowPadding, mOffsetX, mOffsetY);
        }
    }
}