...
public class ExpandTxtTextView extends AppCompatTextView {
    ...
    public ExpandTxtTextView(Context context) {
        this(context, null);
    }

    public ExpandTxtTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ExpandTxtTextView);
        this.trimLength = typedArray.getInt(R.styleable.ExpandTxtTextView_trimLength, DEFAULT_TRIM_LENGTH);
        int resourceIdTrimCollapsedText =
                typedArray.getResourceId(R.styleable.ExpandTxtTextView_trimCollapsedText, R.string.read_more);
        int resourceIdTrimExpandedText =
                typedArray.getResourceId(R.styleable.ExpandTxtTextView_trimExpandedText, R.string.read_less);
        ...
        this.trimLines = typedArray.getInt(R.styleable.ExpandTxtTextView_trimLines, DEFAULT_TRIM_LINES);
        this.colorClickableText = typedArray.getColor(R.styleable.ExpandTxtTextView_colorClickableText,
                ContextCompat.getColor(context, R.color.color_accent));
        this.showTrimExpandedText =
                typedArray.getBoolean(R.styleable.ExpandTxtTextView_showTrimExpandedText, DEFAULT_SHOW_TRIM_EXPANDED_TEXT);
        this.trimMode = typedArray.getInt(R.styleable.ExpandTxtTextView_trimMode, TRIM_MODE_LINES);
        typedArray.recycle();
