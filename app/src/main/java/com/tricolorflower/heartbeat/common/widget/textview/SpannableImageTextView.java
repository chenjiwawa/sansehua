...
public class SpannableImageTextView extends AppCompatTextView {

    public SpannableImageTextView(Context context) {
        super(context, null);
    }

    public SpannableImageTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
