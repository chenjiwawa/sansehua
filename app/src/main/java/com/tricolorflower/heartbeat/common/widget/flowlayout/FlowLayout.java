package com.tricolorflower.heartbeat.common.widget.flowlayout;
...
public class FlowLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isLogOpen) {
            L.i("FlowLayout","FlowLayout  onMeasure  linesSize=" + lines.toString() + "   setMaxLine=" + config.getMaxLines());
        }
