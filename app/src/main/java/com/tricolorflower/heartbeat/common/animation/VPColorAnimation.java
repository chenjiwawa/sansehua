package com.tricolorflower.heartbeat.common.animation;
...
public class VPColorAnimation extends View implements ValueAnimator.AnimatorUpdateListener, Animator.AnimatorListener {
    ...
    public VPColorAnimation(Context context) {
        this(context, null, 0);

    }

    public VPColorAnimation(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VPColorAnimation(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void onAnimationScrolled(int dataCount, int position, float positionOffset) {
        ...
        if (count != 0) {
            ...
            VPColorAnimation.this.seek(progress);
        }
    }
