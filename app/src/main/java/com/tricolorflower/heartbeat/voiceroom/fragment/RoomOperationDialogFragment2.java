...
public class RoomOperationDialogFragment2 extends QsDialogFragment {
    ...
    public static RoomOperationDialogFragment2 getInstance(Bundle extras) {
        RoomOperationDialogFragment2 fragment = new RoomOperationDialogFragment2();
