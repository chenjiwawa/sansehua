...
public class VoiceGuest2EmptyOperationFragment extends VoiceHolderOperationFragment {
    ...
    public static VoiceGuest2EmptyOperationFragment getInstance(Bundle extras) {
        VoiceGuest2EmptyOperationFragment fragment = new VoiceGuest2EmptyOperationFragment();
