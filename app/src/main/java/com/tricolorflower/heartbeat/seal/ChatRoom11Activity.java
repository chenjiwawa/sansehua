...
public class ChatRoom11Activity extends FragmentActivity {

    public final static String TAG = ChatRoom11Activity.class.getSimpleName();
    LinearLayout content;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chatroom11);
