...
public class DefaultChatRoom1Activity extends FragmentActivity {

    public final static String TAG = DefaultChatRoom1Activity.class.getSimpleName();
    LinearLayout content;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_default_chatroom1);
...
//        }).start();
    ...
    String chatRoomId = "OIBbeKlkx";

    String targetId = "" + chatRoomId;
    String title = "聊天室 I";
